...
One useful practice is creating analysis friendly data, such as making each column a variable and each row an observation. I also appreciate the importance of saving files as a CSV or other open, non-proprietary formats. R can be used to view and manage this data. Being able to comment within code and have more details that do not disrupt whatever functions you have is useful. I think Python can be similarly utilized. Both have well-maintained libraries. 
